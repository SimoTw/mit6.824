...
const (
	HEART_BEAT_TIMEER_BASE = 30
	ELECTION_TIMEER_BASE   = 150
	ELECTION_TIMEER_OFFSET = 150
)
...
func (rf *Raft) GetState() (int, bool) {
	...
	// fmt.Printf("isLeader: %v, me: %v, voted for: %v, term: %v\n", isleader, rf.me, rf.votedFor, rf.currentTerm)
	// Your code here (2A).
...
func generateRandTime(base, offset int) time.Duration {
	...
	return time.Millisecond * time.Duration(randInt)
}
